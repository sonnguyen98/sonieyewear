...
export default function ZaloFloatingButton() {
  return (
    <button
      ...
      className="fixed bottom-20 right-4 z-40 flex items-center gap-2 bg-brand-zalo text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 active:scale-95 animate-pulse-zalo md:bottom-6"
    >
      {/* Zalo icon */}
