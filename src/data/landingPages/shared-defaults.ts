...
export const DEFAULT_PERSONAS: LandingPageContent['personas'] = {
  ...
  items: [
    {
      initial: 'T',
      avatar: '/images/landing-pages/shared/personas/anh-tuan.png',
      name: 'Anh Tuấn',
      age: 30,
    ...
    {
      initial: 'L',
      avatar: '/images/landing-pages/shared/personas/chi-linh.png',
      name: 'Chị Linh',
      age: 24,
      role: 'Giáo viên',
      location: '',
    ...
    {
      initial: 'H',
      avatar: '/images/landing-pages/shared/personas/chi-huong.png',
      name: 'Chị Hương',
      age: 28,
    ...
    {
      initial: 'M',
      avatar: '/images/landing-pages/shared/personas/em-minh.png',
      name: 'Em Minh',
      age: 18,
