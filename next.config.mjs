        ...
        headers: [
          ...
          { key: 'Cross-Origin-Embedder-Policy', value: 'credentialless' },
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://maximum-ram-95934.upstash.io https://cdn.jsdelivr.net https://script.google.com https://*.googleusercontent.com https://generativelanguage.googleapis.com https://storage.googleapis.com",
              "media-src 'self' blob:",
